...
# Author:           Travis Bubb
# Description:      The AI agent to play Dots and Boxes
...
class AI:
    ...
    def minimax(self, state, depth, opponent, ai_prev_score, player_prev_score, maximize=True, alpha=-float("inf"), beta=float("inf")):
        ...
        if maximize:
            ...
            for m in moves:
                s, completion = Utils.make_move(state, m, self, ai_prev_score, player_prev_score)
                next_score = self.minimax(s, depth-1, opponent, ai_prev_score, player_prev_score, completion, alpha, beta)
            ...
            for m in moves:
                s, completion = Utils.make_move(state, m, opponent, ai_prev_score, player_prev_score)
                next_score = self.minimax(s, depth-1, opponent, ai_prev_score, player_prev_score, not completion, alpha, beta)
...
# Given a filename for a file containing a game state as a command-line argument      
